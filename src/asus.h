...
static const struct asus_button ASUS_BUTTON_MAPPING[] = {
	...
	{ 0xea, RATBAG_BUTTON_ACTION_TYPE_KEY, 0x200, 0 },  /* side button A */
	{ 0xeb, RATBAG_BUTTON_ACTION_TYPE_KEY, 0x201, 0 },  /* side button B */
	{ 0xec, RATBAG_BUTTON_ACTION_TYPE_KEY, 0x202, 0 },  /* side button C */
	{ 0xed, RATBAG_BUTTON_ACTION_TYPE_KEY, 0x203, 0 },  /* side button D */
	{ 0xee, RATBAG_BUTTON_ACTION_TYPE_KEY, 0x204, 0 },  /* side button E */
	{ 0xef, RATBAG_BUTTON_ACTION_TYPE_KEY, 0x205, 0 },  /* side button F */
};
